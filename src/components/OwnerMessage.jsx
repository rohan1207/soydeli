    ...
    <section className="bg-white py-24 sm:py-32 relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 relative z-10 mb-20">
        ...
        <p className="text-md sm:text-3xl font-bold text-gray-800 text-center leading-relaxed tracking-wide ">
          ...
          Our tofu is made from quality soybeans with just four clean
          ingredients — no preservatives, no shortcuts. Whether you are
          cooking a quick weekday curry or meal-prepping for the week, Soydeli
          gives you high protein you can trust, made right here in Kolhapur by
          Vishal Industries.
        </p>

        <p className="text-center text-emerald-700 font-semibold text-lg mt-8">
          VISHAL INDUSTRIES · MAKERS OF SOYDELI TOFU
        </p>
      </div>
